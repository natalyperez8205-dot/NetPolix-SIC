...
public class Catalogo_Video extends JFrame {
    ...
    private final Video_Dao videoDao =
            new Video_Dao();

    private final Carrito_Dao carritoDao =
            new Carrito_Dao();
    ...
    public Catalogo_Video(Usuario usuario) {
        ...
        listaVideos =
                new JList<>(modeloVideos);

        listaVideos.setSelectionMode(
        ...
        btnRefrescar
                .addActionListener(e -> cargarVideos());
